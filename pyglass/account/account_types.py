...
class Insights:
    def __init__(self, request: dict) -> None:
        ...
        self.lastIn_tx_unix_timestamp: int = request["number"]
        ...
        self.max_amount_sentHash: str = request["string"]
        self.max_balance: float = request["number"]
        self.max_balanceHash: str = request["string"]
...
class Representative:
    def __init__(self, request: dict) -> None:
        self.representative: str = request["representative"]
